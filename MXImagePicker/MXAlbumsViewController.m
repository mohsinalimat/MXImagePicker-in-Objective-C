...
#import "MXAlbumsViewController.h"
...
@interface MXAlbumsViewController () <PHPhotoLibraryChangeObserver>
...
@implementation MXAlbumsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"MXImagePicker", self.imagePickerController.assetBundle, nil);
...
{
    MXAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    if ([self.imagePickerController.delegate respondsToSelector:@selector(mx_imagePickerControllerDidCancel:)]) {
        [self.imagePickerController.delegate mx_imagePickerControllerDidCancel:self.imagePickerController];
    }
}
...
{
    MXAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
